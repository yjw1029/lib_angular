...
import { MatSort, MatChipInputEvent, MatTableDataSource} from '@angular/material';
...
@Component({
  selector: 'app-mng-consult',
  templateUrl: './mng-consult.component.html',
  styleUrls: ['./mng-consult.component.css']
})
export class MngConsultComponent implements OnInit {
